<template>
  <div style="position: relative">
    <div class="verify-img-out" :style="{ height: parseInt(setSize.imgHeight) + vSpace + 'px' }" v-if="type === '2'">
      <div class="verify-img-panel" :style="{ width: setSize.imgWidth, height: setSize.imgHeight }">
        <img alt="" :src="backImgBase ? 'data:image/png;base64,' + backImgBase : defaultImg" style="width: 100%; height: 100%; display: block" />
        <div class="verify-refresh" @click="refresh" v-show="showRefresh">
          <i class="iconfont icon-refresh" />
        </div>
        <transition name="tips">
          <span class="verify-tips" :class="passFlag ? 'suc-bg' : 'err-bg'" v-if="tipWords">{{ tipWords }}</span>
        </transition>
      </div>
    </div>
    <!-- 公共部分 -->
      ...
      >
        ...
        >
          ...
          <div
            ...
            v-if="type === '2'"
          >
            <img alt="" :src="'data:image/png;base64,' + blockBackImgBase" style="width: 100%; height: 100%; display: block" />
          </div>
        </div>
      </div>
    </div>
