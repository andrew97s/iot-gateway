  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="3">
        周期从
        <el-input-number v-model="cycle01" :max="30" :min="1" /> - <el-input-number v-model="cycle02" :max="31" :min="cycle01 + 1" /> 日
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="4">
        ...
        <el-input-number v-model="average02" :max="31 - average01" :min="1" /> 日执行一次
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="7">
        ...
        <el-select v-model="checkboxList" clearable multiple :multiple-limit="10" placeholder="可多选">
          <el-option v-for="item in 31" :label="item" :value="item" :key="item" />
        </el-select>
      </el-radio>
    </el-form-item>
  </el-form>
