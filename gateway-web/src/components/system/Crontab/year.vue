  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="4">
        从
        <el-input-number v-model="average01" :max="maxFullYear - 1" :min="fullYear" /> 年开始，每
        <el-input-number v-model="average02" :max="10" :min="1" /> 年执行一次
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="5">
        ...
        <el-select v-model="checkboxList" clearable multiple :multiple-limit="8" placeholder="可多选">
          <el-option v-for="item in 9" :label="item - 1 + fullYear" :value="item - 1 + fullYear" :key="item" />
        </el-select>
      </el-radio>
    </el-form-item>
  </el-form>
