  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="2">
        周期从
        <el-input-number v-model="cycle01" :max="58" :min="0" /> - <el-input-number v-model="cycle02" :max="59" :min="cycle01 + 1" /> 分钟
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="3">
        从
        <el-input-number v-model="average01" :max="58" :min="0" /> 分钟开始， 每
        <el-input-number v-model="average02" :max="59 - average01" :min="1" /> 分钟执行一次
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="4">
        ...
        <el-select v-model="checkboxList" clearable multiple :multiple-limit="10" placeholder="可多选">
          <el-option v-for="item in 60" :label="item - 1" :value="item - 1" :key="item" />
        </el-select>
      </el-radio>
    </el-form-item>
  </el-form>
