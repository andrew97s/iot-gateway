  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="2">
        周期从
        <el-input-number v-model="cycle01" :max="11" :min="1" /> - <el-input-number v-model="cycle02" :max="12" :min="cycle01 + 1" /> 月
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="3">
        ...
        <el-input-number v-model="average02" :max="12 - average01" :min="1" /> 月月执行一次
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="4">
        ...
        <el-select v-model="checkboxList" clearable multiple :multiple-limit="8" placeholder="可多选">
          <el-option v-for="item in monthList" :label="item.value" :value="item.key" :key="item.key" />
        </el-select>
      </el-radio>
    </el-form-item>
  </el-form>
