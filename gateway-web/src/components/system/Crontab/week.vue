  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="3">
        ...
        <el-select v-model="cycle01" clearable>
          <el-option v-for="(item, index) of weekList" :disabled="item.key === 7" :label="item.value" :value="item.key" :key="index">
            {{ item.value }}
          </el-option>
        </el-select>
        -
        <el-select v-model="cycle02" clearable>
          <el-option v-for="(item, index) of weekList" :disabled="item.key <= cycle01" :label="item.value" :value="item.key" :key="index">
            {{ item.value }}
          </el-option>
        </el-select>
      </el-radio>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="4">
        第
        <el-input-number v-model="average01" :max="4" :min="1" /> 周的
        <el-select v-model="average02" clearable>
          <el-option v-for="item in weekList" :label="item.value" :value="item.key" :key="item.key" />
        </el-select>
      </el-radio>
    </el-form-item>
