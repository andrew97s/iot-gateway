  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="2">
        周期从
        <el-input-number v-model="cycle01" :max="58" :min="0" /> - <el-input-number v-model="cycle02" :max="59" :min="cycle01 + 1" /> 秒
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="3">
        从
        <el-input-number v-model="average01" :max="58" :min="0" /> 秒开始，每
        <el-input-number v-model="average02" :max="59 - average01" :min="1" /> 秒执行一次
      </el-radio>
    </el-form-item>
