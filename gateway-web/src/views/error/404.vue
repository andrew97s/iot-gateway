<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">您没有访问权限，或该页面不存在</div>
        <!-- <div class="bullshit__headline">
          找不到页面
        </div> -->
        <div class="bullshit__info">请检查URL的地址是否正确或联系管理员</div>
        <router-link class="bullshit__return-home" :to="defaultSettings.homePath"> 返回首页 </router-link>
        <el-button class="btn-logout" round size="default" @click="logout"> 退出登录 </el-button>
      </div>
    </div>
  </div>
</template>
