  ...
  <el-card>
    <el-tabs v-model="activeName">
      <el-tab-pane label="基本信息" name="basic">
        <basic-info-form :info="info" ref="basicInfo" />
      </el-tab-pane>
      <el-tab-pane label="字段信息" name="columnInfo">
        <el-table :data="columns" :max-height="tableHeight" row-key="columnId" ref="dragTable">
          <el-table-column label="序号" min-width="5%" type="index" />
          <el-table-column label="字段列名" min-width="10%" prop="columnName" :show-overflow-tooltip="true" />
          <el-table-column label="字段描述" min-width="10%">
            <template #default="scope">
              <el-input v-model="scope.row.columnComment"></el-input>
            </template>
          </el-table-column>
          <el-table-column label="物理类型" min-width="10%" prop="columnType" :show-overflow-tooltip="true" />
          ...
          <el-table-column label="字典类型" min-width="12%">
            <template #default="scope">
              <el-select v-model="scope.row.dictType" clearable filterable placeholder="请选择">
                <el-option v-for="dict in dictOptions" :label="dict.dictName" :value="dict.dictType" :key="dict.dictType">
      ...
      <el-tab-pane label="生成信息" name="genInfo">
        <gen-info-form :info="info" :tables="tables" ref="genInfo" />
      </el-tab-pane>
    </el-tabs>
