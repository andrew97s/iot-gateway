<template>
  ...
  <el-dialog v-model="visible" append-to-body title="导入表" top="5vh" width="800px">
    ...
    <el-row style="position: relative">
      <el-table :data="dbTableList" height="260px" ref="table" @row-click="clickRow" @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55"></el-table-column>
        <el-table-column label="表名称" prop="tableName" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column label="表描述" prop="tableComment" :show-overflow-tooltip="true"></el-table-column>
