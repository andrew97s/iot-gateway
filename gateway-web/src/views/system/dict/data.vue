<template>
  <div class="app-container">
    <el-form :inline="true" :model="queryParams" ref="queryRef" v-show="showSearch">
      <el-form-item label="字典名称" prop="dictType">
        <el-select v-model="queryParams.dictType" style="width: 200px">
          <el-option v-for="item in typeOptions" :label="item.dictName" :value="item.dictType" :key="item.dictId" />
        </el-select>
      </el-form-item>
      <el-form-item label="字典标签" prop="dictLabel">
        <el-input v-model="queryParams.dictLabel" clearable placeholder="请输入字典标签" style="width: 200px" @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-row class="mb8" :gutter="10">
      ...
      <el-col :span="1.5">
        <el-button :disabled="single" icon="Edit" plain type="success" v-hasPermi="['system:dict:edit']" @click="handleUpdate">修改</el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table :data="dataList" v-loading="loading" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="字典标签" prop="dictLabel">
        <template #default="scope">
          ...
          <el-tag :type="scope.row.listClass == 'primary' ? '' : scope.row.listClass" v-else>{{ scope.row.dictLabel }}</el-tag>
        </template>
      </el-table-column>
    ...
    <el-dialog v-model="open" append-to-body :title="title" width="600px">
      <el-form label-width="80px" :model="form" :rules="rules" ref="dataRef">
