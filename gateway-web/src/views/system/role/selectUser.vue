  ...
  <el-dialog v-model="visible" append-to-body title="选择用户" top="5vh" width="800px">
    <el-form :inline="true" :model="queryParams" ref="queryRef">
      ...
      <el-form-item label="手机号码" prop="phonenumber">
        <el-input v-model="queryParams.phonenumber" clearable placeholder="请输入手机号码" style="width: 200px" @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row>
      <el-table :data="userList" height="260px" ref="refTable" @row-click="clickRow" @selection-change="handleSelectionChange">
