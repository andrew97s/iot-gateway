  ...
  <div class="app-container">
    <el-form :inline="true" :model="queryParams" ref="queryRef">
      ...
      <el-form-item label="账号" prop="userName">
        <el-input v-model="queryParams.userName" clearable placeholder="请输入账号" style="width: 200px" @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="onlineList.slice((pageNum - 1) * pageSize, pageNum * pageSize)" style="width: 100%" v-loading="loading">
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
        <template #default="scope">
          <el-button icon="Delete" link type="primary" v-hasPermi="['monitor:online:forceLogout']" @click="handleForceLogout(scope.row)">
            强退
          </el-button>
        </template>
      </el-table-column>
    ...
    <pagination v-model:limit="pageSize" v-model:page="pageNum" :total="total" v-show="total > 0" />
  </div>
</template>
