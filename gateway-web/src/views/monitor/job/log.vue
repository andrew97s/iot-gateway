<template>
  <div class="app-container">
    ...
    <el-row class="mb8" :gutter="10">
      ...
      <el-col :span="1.5">
        <el-button icon="Delete" plain type="danger" v-hasPermi="['monitor:job:remove']" @click="handleClean"> 清空 </el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table :data="jobLogList" v-loading="loading" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
        <template #default="scope">
          <el-button icon="View" link type="primary" v-hasPermi="['monitor:job:query']" @click="handleView(scope.row)">详细</el-button>
        </template>
      </el-table-column>
    </el-table>
