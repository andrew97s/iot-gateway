            ...
            <table cellspacing="0" style="width: 100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="el-table__cell is-leaf">
                    <div class="cell" :class="{ 'text-danger': server.mem.usage > 80 }" v-if="server.mem">{{ server.mem.usage }}%</div>
                  </td>
                  <td class="el-table__cell is-leaf">
                    <div class="cell" :class="{ 'text-danger': server.jvm.usage > 80 }" v-if="server.jvm">{{ server.jvm.usage }}%</div>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%; table-layout: fixed">
              <tbody>
                ...
                <tr>
                  <td class="el-table__cell is-leaf" colspan="1"><div class="cell">安装路径</div></td>
                  <td class="el-table__cell is-leaf" colspan="3">
                    <div class="cell" v-if="server.jvm">{{ server.jvm.home }}</div>
                  </td>
                </tr>
                <tr>
                  <td class="el-table__cell is-leaf" colspan="1"><div class="cell">项目路径</div></td>
                  <td class="el-table__cell is-leaf" colspan="3">
                    <div class="cell" v-if="server.sys">{{ server.sys.userDir }}</div>
                  </td>
                </tr>
                <tr>
                  <td class="el-table__cell is-leaf" colspan="1"><div class="cell">运行参数</div></td>
                  <td class="el-table__cell is-leaf" colspan="3">
