  ...
  <div class="app-container">
    <el-form :inline="true" label-width="68px" :model="queryParams" ref="queryRef" v-show="showSearch">
      <el-form-item label="登录地址" prop="ipaddr">
        <el-input v-model="queryParams.ipaddr" clearable placeholder="请输入登录地址" style="width: 240px" @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-row class="mb8" :gutter="10">
      <el-col :span="1.5">
        <el-button :disabled="multiple" icon="Delete" plain type="danger" v-hasPermi="['monitor:logininfor:remove']" @click="handleDelete">
          删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button icon="Delete" plain type="danger" v-hasPermi="['monitor:logininfor:remove']" @click="handleClean"> 清空 </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button :disabled="single" icon="Unlock" plain type="primary" v-hasPermi="['monitor:logininfor:unlock']" @click="handleUnlock">
          解锁
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button icon="Download" plain type="warning" v-hasPermi="['monitor:logininfor:export']" @click="handleExport"> 导出 </el-button>
      </el-col>
