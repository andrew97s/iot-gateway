...
public class CustomLicenseManager extends LicenseManager{
    ...
    private Object load(String encoded){
        ...
        try {
            String licenseRep = encoded.replace("com.license.core.LicenseCheckModel", LicenseCheckModel.class.getCanonicalName());
            inputStream = new BufferedInputStream(new ByteArrayInputStream(licenseRep.getBytes(XML_CHARSET)));
