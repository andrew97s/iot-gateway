...
import com.zhian.gateway.system.domain.SysPost;
...
public class SysUserServiceImpl implements ISysUserService
{
    ...
    public String importUser(List<SysUser> userList, Boolean isUpdateSupport, String operName)
    {
        ...
        for (SysUser user : userList)
        {
            try
            {
                if (user.getDept().getDeptName() != null) {
                    SysDept sysDept = sysDeptMapper.selectDeptByName(user.getDept().getDeptName());
                    if (sysDept == null) {
                        throw new ServiceException("不存在该部门: " + user.getDept().getDeptName()+", 请检查!");
                    }
